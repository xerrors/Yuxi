...
知伴最小业务版先补学生档案、角色权限、团队与个人知识库及会话背景关联，真实模型联调安排在业务版验收之后。范围、取舍和分批验收见[实施提案](./decisions/proposed/2026-09-12-counseling-minimal-release.md)。当前已完成规划整理和基础品牌展示，业务能力尚未实现。
